        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div class="w-full">
                    ...
                    <p class="text-sm sm:text-base text-steel-blue/80 font-medium">Perbarui data akun <span class="font-semibold">{{ $user->username }}</span></p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <a href="{{ route('admin.users.index') }}" class="w-full md:w-auto inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-white text-navy-blue font-semibold rounded-xl shadow-sm border border-soft-gray hover:bg-off-white transition-all duration-200 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-navy-blue/50">
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-soft-gray overflow-hidden">
                ...
                <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-soft-gray bg-off-white/50">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-xl bg-navy-blue/10 flex items-center justify-center mr-3 sm:mr-4 overflow-hidden border border-soft-gray">
                            @if($user->foto_profil)
                                <img src="{{ asset('storage/' . $user->foto_profil) }}" alt="Foto Profil" class="w-full h-full object-cover">
                            @else
                                <svg class="w-6 h-6 sm:w-8 sm:h-8 text-navy-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            @endif
                        </div>
                ...
                <div class="p-4 sm:p-6">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-steel-blue/60 mt-1">Biarkan kosong jika tidak ingin mengubah foto. (Max: 2MB)</p>
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-navy-blue mb-2">Username <span class="text-red-500 ml-1">*</span></label>
                            <input type="text" name="username" value="{{ old('username', $user->username) }}" class="w-full px-4 py-3 rounded-xl border border-soft-gray bg-white text-charcoal placeholder-charcoal/40 focus:outline-none focus:ring-2 focus:ring-navy-blue/30 focus:border-navy-blue/50 transition-all duration-200" placeholder="Username untuk login" required>
                            <p class="text-xs text-steel-blue/60 mt-1">Tidak dapat diubah setelah dibuat</p>
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-navy-blue mb-2">Password Baru <span class="text-steel-blue/60 font-normal text-xs ml-1">(Opsional)</span></label>
                            <div class="relative">
                                <input type="password" name="password" class="w-full px-4 py-3 rounded-xl border border-soft-gray bg-white text-charcoal placeholder-charcoal/40 focus:outline-none focus:ring-2 focus:ring-navy-blue/30 focus:border-navy-blue/50 transition-all duration-200" placeholder="Isi hanya jika ingin mengganti password">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="w-5 h-5 text-steel-blue/40" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </div>
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-navy-blue"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></div>
                            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center p-4 rounded-xl border border-soft-gray bg-off-white/30 hover:bg-off-white/50 transition-colors duration-150 cursor-pointer" onclick="document.getElementById('statusToggle').click()">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-steel-blue/60 mt-0.5">Nonaktifkan untuk menangguhkan akses pengguna ini</p>
                                </div>
