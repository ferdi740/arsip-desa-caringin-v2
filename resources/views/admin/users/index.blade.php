                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-white mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 5.197V21m0 0h-6m6 0v-1a6 6 0 00-9-5.197M9 9a4 4 0 118 0"/>
                        </svg>
                    ...
                    <div class="p-4 hover:bg-off-white/30 transition-colors duration-150">
                        ...
                        <div class="mb-3 pl-13">
                            <div class="flex items-center text-sm text-charcoal mb-1">
                                <svg class="w-4 h-4 mr-2 text-charcoal/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-8 text-center">
                        <div class="w-14 h-14 mx-auto mb-3 rounded-full bg-off-white flex items-center justify-center">
                            <svg class="w-7 h-7 text-charcoal/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 5.197V21m0 0h-6m6 0v-1a6 6 0 00-9-5.197M9 9a4 4 0 118 0"/>
                            </svg>
                        </div>
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-t border-soft-gray bg-off-white">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                    <div class="text-xs text-steel-blue/60">
                        * Klik ikon edit atau hapus untuk mengelola pengguna
                    </div>
